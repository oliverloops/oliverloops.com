...
export default function Header() {
  ...
  return (
    <div className="flex justify-center parent-sticky-nav">
      <div className="transition duration-300 flex justify-center items-center w-full md:w-3/4 xl:w-1/2 px-8 py-4 md:px-0 md:py-0 mt-4 bg-gray-200 rounded-full border-slate-200 dark:bg-gray-700 bg-opacity-40 dark:bg-opacity-60 sticky sticky-nav">
