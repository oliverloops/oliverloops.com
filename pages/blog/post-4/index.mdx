...
<p className="basic-text break-words text-md text-left leading-relaxed text-gray-700 dark:text-white">
...
<p className="basic-text break-words text-md text-left leading-relaxed text-gray-700 dark:text-white mt-4">
