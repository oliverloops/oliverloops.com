...
<div>
  <Image
    priority
    src={
      "/static/images/blog_img/nextjs-and-formspree/next_formspree_banner.svg"
    }
...
<blockquote className="base-text break-words text-md text-left leading-relaxed">
  <i>
    “Focusing on the front-end is the most customer-obsessive way to build your
    products.” — <span>Guillermo Rauch, Vercel CEO</span>
  </i>
</blockquote>

<h2 className="mt-8 mb-4 text-2xl font-bold">Why use this solution?</h2>
...
<h2 className="mt-8 mb-4 text-2xl font-bold">Getting Started</h2>
...
<h2 className="mt-8 mb-4 text-2xl font-bold">Up and Running with Next.js</h2>
...
<h2 className="mt-8 mb-4 text-2xl font-bold">Now it's time to code</h2>
...
<SyntaxHighlighter language="javascript" className="rounded-xl overflow-hidden">
    {`
...
<h2 className="mt-8 mb-4 text-2xl font-bold">Last step...</h2>
